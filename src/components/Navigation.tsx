  ...
  return (
    <nav ref={mobileMenuRef} className="sticky top-0 left-0 right-0 z-[100] backdrop-blur-3xl bg-transparent border border-white/10 border-t-0 shadow-2xl shadow-black/20">
      ...
      <div className={`md:hidden transition-all duration-300 ease-in-out overflow-hidden ${
        ...
        <div className="px-4 py-6 bg-gray-900/95 backdrop-blur-lg border-t border-[#F6F6F6]/10">
          <div className="flex flex-col gap-4">
            {/* Mobile navigation links */}
            {isAdmin && (
              <Link 
                href="/admin" 
                className="block px-4 py-3 text-white/90 font-semibold text-lg transition-all duration-300 hover:text-white hover:bg-[#F6F6F6]/10 rounded-lg border border-transparent hover:border-[#F6F6F6]/20"
            ...
            <div className="px-4 py-2">
              <p className="text-white/70 text-sm font-medium mb-3">Connect with us</p>
              <div className="flex gap-4">
                <a 
                  ...
                  rel="noopener noreferrer"
                  title="Give Star on GitHub"
                  className="flex items-center justify-center w-12 h-12 rounded-full bg-[#F6F6F6]/10 backdrop-blur-sm border border-[#F6F6F6]/20 text-white/90 hover:text-white transition-all duration-300 hover:bg-[#F6F6F6]/20 hover:border-[#F6F6F6]/40"
                >
                ...
                <a 
                  ...
                  rel="noopener noreferrer"
                  title="Connect on LinkedIn"
                  className="flex items-center justify-center w-12 h-12 rounded-full bg-[#F6F6F6]/10 backdrop-blur-sm border border-[#F6F6F6]/20 text-white/90 hover:text-white transition-all duration-300 hover:bg-[#0077B5]/20 hover:border-[#0077B5]/40"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433c-1.144 0-2.063-.926-2.063-2.065 0-1.138.92-2.063 2.063-2.063 1.14 0 2.064.925 2.064 2.063 0 1.139-.925 2.065-2.064 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                  </svg>
                ...
                <a 
                  ...
                  rel="noopener noreferrer"
                  title="Follow on X (Twitter)"
                  className="flex items-center justify-center w-12 h-12 rounded-full bg-[#F6F6F6]/10 backdrop-blur-sm border border-[#F6F6F6]/20 text-white/90 hover:text-white transition-all duration-300 hover:bg-[#1DA1F2]/20 hover:border-[#1DA1F2]/40"
                >
                  <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/>
                  </svg>
            ...
            {/* Mobile auth buttons */}
            <div className="flex flex-col gap-3 px-4 pt-4 border-t border-[#F6F6F6]/10">
              <SignedOut>
                <SignInButton>
                  <button className="w-full px-6 py-3 rounded-xl border border-[#F6F6F6]/30 bg-[#F6F6F6]/5 backdrop-blur-sm text-white/90 font-semibold transition-all duration-300 hover:border-[#F6F6F6]/50 hover:text-white hover:bg-[#F6F6F6]/10">
                    Login
                  </button>
                </SignInButton>
                <SignUpButton>
                  <button className="w-full px-6 py-3 rounded-xl border border-[#A2D5C6]/50 bg-gradient-to-r from-[#A2D5C6]/80 via-[#CFFFE2]/80 to-[#F6F6F6]/80 backdrop-blur-sm text-black font-semibold transition-all duration-300 hover:shadow-lg hover:shadow-[#A2D5C6]/30">
                    Sign Up
                  </button>
                </SignUpButton>
              </SignedOut>
              <SignedIn>
                <div className="flex items-center justify-between p-4 bg-[#F6F6F6]/10 backdrop-blur-md rounded-xl border border-[#F6F6F6]/20">
